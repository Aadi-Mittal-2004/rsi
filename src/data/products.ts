...
export const products: Product[] = [
    // Quartzite & Slate
    {
      ...
      category: "quartzite",
      description: "A vibrant, rustic slate characterized by its deep red hues and natural cleft texture. This durable stone brings warmth and earthy charm to any space, making it a standout choice for traditional and contemporary designs alike.",
    ...
    },
    {
      ...
      name: "Silver Shine",
      category: "quartzite",
      description: "A stunning quartzite featuring a shimmering silver-grey surface with subtle metallic notes. Its natural cleft finish captures light beautifully, adding a touch of glamour and sophistication to interiors and exteriors.",
    ...
    },
    {
      ...
      category: "quartzite",
      description: "Sleek and sophisticated, this polished quartzite offers a smooth silver-grey finish. It combines the durability of quartzite with a refined aesthetic, perfect for modern architectural projects requiring a clean look.",
    ...
    },
    {
      ...
      category: "quartzite",
      description: "A luxurious polished quartzite with deep green tones and sparkling mica inclusions. The polished surface enhances the stone's rich color depth, creating an elegant and high-end visual appeal.",
    ...
    // Sandstone
    {
      ...
      name: "Teakwood",
      category: "sandstone",
      description: "A luxurious fine-grained sandstone featuring distinct wood-like veining in golden and yellow tones. Its smooth texture and natural patterns create an elegant, timber-like aesthetic without the maintenance of real wood.",
    ...
    },
    {
      ...
      name: "Rainbow",
      category: "sandstone",
      description: "A visually striking sandstone known for its intense swirls of violet, plum, and orange. Each slab is unique, offering a vibrant and artistic kaleidoscope of natural colors that serves as a bold focal point.",
